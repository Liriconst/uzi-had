    ...
    public render(): React.ReactNode {
        return (
            <div className={styles.pageHome}>
                <div className={styles.homeHeader}><span>НАШИ ПРЕИМУЩЕСТВА</span></div>
                <div className={styles.homeAdvantages}>
                    <div className={styles.homeAdvantageTemplate}>
                        ...
                        <div className={styles.homeAdvantageTemplateText}>Мы уже более 9 лет проводим ультразвуковые</div>
                        ...
                        <div className={styles.homeAdvantageTemplateText}>Также, более 20 лет практики в функциональной</div>
                    ...
                    <div className={styles.homeAdvantageTemplate}>
                        ...
                        <div className={styles.homeAdvantageTemplateLink}><Link to="/news">Подробнее о нас</Link></div>
                    </div>
                    <span className={styles.homeAdvantageSeparator}/>
                    <div className={styles.homeAdvantageTemplate}>
                        <div className={styles.homeAdvantageTemplateImg}>
                        ...
                        <div className={styles.homeAdvantageTemplateLink}><Link to="/news">Подробнее о наших услугах</Link></div>
                    </div>
                </div>
                <div className={styles.homeFooter}>
                    ...
                    <div className={styles.homeFooterRemark}>Нажимая на кнопку "Записатьcя", Вы даете Согласие на обработку персональных данных на&nbsp;<span className={styles.homeFooterRemarkLink}><Link to="/news">следующих условиях</Link></span></div>
                </div>
            </div>
        );
    }
